...
export function ProductsManagementDrawer({
  ...
  return (
    <>
      ...
      <aside className="fixed right-0 top-0 z-50 flex h-screen w-full max-w-3xl flex-col border-l border-slate-200 bg-white shadow-[-24px_0_60px_rgba(15,23,42,0.16)]">
            ...
            {isLoading ? (
              ...
              <div className="space-y-3">
                {products.map((product, index) => (
                  <article
                    key={product.id}
                    className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-[0_14px_34px_rgba(15,23,42,0.05)]"
                  >
