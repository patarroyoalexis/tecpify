...
- El board desktop operativo vive por estados del pedido y deja `cancelado` en una seccion secundaria; la revision de pago se resuelve dentro de `nuevo` y la semantica visual/CTA queda centralizada para reutilizarse despues en movil.
